...
//{{{ begin codeInclude
#line 36 "/d1/home/bini/General/paperWithJoel/Run_for_paper/withParametrization/2D/case1/0/omega.boundaryField.bottomWall"
#include "fvCFD.H"
                #include "cmath"
                #include "iostream"
//}}} end codeInclude
...
{
    // dynamicCode:
    // SHA1 = f4650f6b961fbab9c2a81a033dfef523431baf3e
    //
    // unique function name that can be checked if the correct library version
    // has been loaded
    void ModifiedForRoughness_f4650f6b961fbab9c2a81a033dfef523431baf3e(bool load)
    {
        if (load)
        {
...
const char* const ModifiedForRoughnessFixedValueFvPatchScalarField::SHA1sum =
    "f4650f6b961fbab9c2a81a033dfef523431baf3e";
    ...
    fixedValueFvPatchField<scalar>(p, iF)
{
    if (false)
    {
        Info<<"construct ModifiedForRoughness sha1: f4650f6b961fbab9c2a81a033dfef523431baf3e"
...
~ModifiedForRoughnessFixedValueFvPatchScalarField()
{
    if (false)
    {
        Info<<"destroy ModifiedForRoughness sha1: f4650f6b961fbab9c2a81a033dfef523431baf3e\n";
    }
}
...
void ModifiedForRoughnessFixedValueFvPatchScalarField::updateCoeffs()
{
    ...
    if (false)
    {
        Info<<"updateCoeffs ModifiedForRoughness sha1: f4650f6b961fbab9c2a81a033dfef523431baf3e\n";
    }

//{{{ begin code
    #line 56 "/d1/home/bini/General/paperWithJoel/Run_for_paper/withParametrization/2D/case1/0/omega.boundaryField.bottomWall"
const fvPatch& boundaryPatch = patch();                // give access to boundary mesh patch mesh
      ...
      //    const vectorField& normal = patch().nf();              // give access to the face normal 
            ...
            scalar Zr = 2.00;                                      // roughness to be incorporated 
