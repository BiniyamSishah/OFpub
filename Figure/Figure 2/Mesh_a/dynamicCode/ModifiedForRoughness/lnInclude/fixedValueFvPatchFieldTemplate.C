...
//{{{ begin codeInclude
#line 36 "/d1/home/bini/General/paperWithJoel/AdanedOF/dakota/Ap2dp2T7/workdir.5/0/omega.boundaryField.bottomWall"
#include "fvCFD.H"
                #include "cmath"
                #include "iostream"
//}}} end codeInclude
...
{
    // dynamicCode:
    // SHA1 = be88d5a76248b5c62fb6653bd990ac27b478fa0d
    //
    // unique function name that can be checked if the correct library version
    // has been loaded
    void ModifiedForRoughness_be88d5a76248b5c62fb6653bd990ac27b478fa0d(bool load)
    {
        if (load)
        {
...
const char* const ModifiedForRoughnessFixedValueFvPatchScalarField::SHA1sum =
    "be88d5a76248b5c62fb6653bd990ac27b478fa0d";
    ...
    fixedValueFvPatchField<scalar>(p, iF)
{
    if (false)
    {
        Info<<"construct ModifiedForRoughness sha1: be88d5a76248b5c62fb6653bd990ac27b478fa0d"
...
~ModifiedForRoughnessFixedValueFvPatchScalarField()
{
    if (false)
    {
        Info<<"destroy ModifiedForRoughness sha1: be88d5a76248b5c62fb6653bd990ac27b478fa0d\n";
    }
}
...
void ModifiedForRoughnessFixedValueFvPatchScalarField::updateCoeffs()
{
    ...
    if (false)
    {
        Info<<"updateCoeffs ModifiedForRoughness sha1: be88d5a76248b5c62fb6653bd990ac27b478fa0d\n";
    }

//{{{ begin code
    #line 56 "/d1/home/bini/General/paperWithJoel/AdanedOF/dakota/Ap2dp2T7/workdir.5/0/omega.boundaryField.bottomWall"
const fvPatch& boundaryPatch = patch();                // give access to boundary mesh patch mesh
      ...
      //    const vectorField& normal = patch().nf();              // give access to the face normal 
            ...
            scalar Zr = 4.800000000000000e-01;                                      // roughness to be incorporated 
