...
//{{{ begin codeInclude
#line 36 "/d1/home/bini/General/paperWithJoel/AdanedOF/dakota/Ap1dp2T7/workdir.3/0/omega.boundaryField.bottomWall"
#include "fvCFD.H"
                #include "cmath"
                #include "iostream"
//}}} end codeInclude
...
{
    // dynamicCode:
    // SHA1 = c8870b414b1895ec89dd63a0da6e8df3482c945b
    //
    // unique function name that can be checked if the correct library version
    // has been loaded
    void ModifiedForRoughness_c8870b414b1895ec89dd63a0da6e8df3482c945b(bool load)
    {
        if (load)
        {
...
const char* const ModifiedForRoughnessFixedValueFvPatchScalarField::SHA1sum =
    "c8870b414b1895ec89dd63a0da6e8df3482c945b";
    ...
    fixedValueFvPatchField<scalar>(p, iF)
{
    if (false)
    {
        Info<<"construct ModifiedForRoughness sha1: c8870b414b1895ec89dd63a0da6e8df3482c945b"
...
~ModifiedForRoughnessFixedValueFvPatchScalarField()
{
    if (false)
    {
        Info<<"destroy ModifiedForRoughness sha1: c8870b414b1895ec89dd63a0da6e8df3482c945b\n";
    }
}
...
void ModifiedForRoughnessFixedValueFvPatchScalarField::updateCoeffs()
{
    ...
    if (false)
    {
        Info<<"updateCoeffs ModifiedForRoughness sha1: c8870b414b1895ec89dd63a0da6e8df3482c945b\n";
    }

//{{{ begin code
    #line 56 "/d1/home/bini/General/paperWithJoel/AdanedOF/dakota/Ap1dp2T7/workdir.3/0/omega.boundaryField.bottomWall"
const fvPatch& boundaryPatch = patch();                // give access to boundary mesh patch mesh
      ...
      //    const vectorField& normal = patch().nf();              // give access to the face normal 
            ...
            scalar Zr = 2.600000000000000e-01;                                      // roughness to be incorporated 
