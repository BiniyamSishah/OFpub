...
//{{{ begin codeInclude
#line 36 "/d1/home/bini/General/paperWithJoel/AdanedOF/dakota/Ap3dp2T7/workdir.2/0/omega.boundaryField.bottomWall"
#include "fvCFD.H"
                #include "cmath"
                #include "iostream"
//}}} end codeInclude
...
{
    // dynamicCode:
    // SHA1 = a9a789c06614b6c54487ce54324cb18c11567293
    //
    // unique function name that can be checked if the correct library version
    // has been loaded
    void ModifiedForRoughness_a9a789c06614b6c54487ce54324cb18c11567293(bool load)
    {
        if (load)
        {
...
const char* const ModifiedForRoughnessFixedValueFvPatchScalarField::SHA1sum =
    "a9a789c06614b6c54487ce54324cb18c11567293";
    ...
    fixedValueFvPatchField<scalar>(p, iF)
{
    if (false)
    {
        Info<<"construct ModifiedForRoughness sha1: a9a789c06614b6c54487ce54324cb18c11567293"
...
~ModifiedForRoughnessFixedValueFvPatchScalarField()
{
    if (false)
    {
        Info<<"destroy ModifiedForRoughness sha1: a9a789c06614b6c54487ce54324cb18c11567293\n";
    }
}
...
void ModifiedForRoughnessFixedValueFvPatchScalarField::updateCoeffs()
{
    ...
    if (false)
    {
        Info<<"updateCoeffs ModifiedForRoughness sha1: a9a789c06614b6c54487ce54324cb18c11567293\n";
    }

//{{{ begin code
    #line 56 "/d1/home/bini/General/paperWithJoel/AdanedOF/dakota/Ap3dp2T7/workdir.2/0/omega.boundaryField.bottomWall"
const fvPatch& boundaryPatch = patch();                // give access to boundary mesh patch mesh
      ...
      //    const vectorField& normal = patch().nf();              // give access to the face normal 
            ...
            scalar Zr = 1.25000000000000000e+00;                                      // roughness to be incorporated 
