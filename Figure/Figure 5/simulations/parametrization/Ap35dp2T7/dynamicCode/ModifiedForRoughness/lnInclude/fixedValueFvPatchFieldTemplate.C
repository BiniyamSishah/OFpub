...
//{{{ begin codeInclude
#line 36 "/d1/home/bini/General/paperWithJoel/AdanedOF/dakota/Ap35dp2T7/workdir.10/0/omega.boundaryField.bottomWall"
#include "fvCFD.H"
                #include "cmath"
                #include "iostream"
//}}} end codeInclude
...
{
    // dynamicCode:
    // SHA1 = 23a0898b871225a107d840bf2d00f9cd44412810
    //
    // unique function name that can be checked if the correct library version
    // has been loaded
    void ModifiedForRoughness_23a0898b871225a107d840bf2d00f9cd44412810(bool load)
    {
        if (load)
        {
...
const char* const ModifiedForRoughnessFixedValueFvPatchScalarField::SHA1sum =
    "23a0898b871225a107d840bf2d00f9cd44412810";
    ...
    fixedValueFvPatchField<scalar>(p, iF)
{
    if (false)
    {
        Info<<"construct ModifiedForRoughness sha1: 23a0898b871225a107d840bf2d00f9cd44412810"
...
~ModifiedForRoughnessFixedValueFvPatchScalarField()
{
    if (false)
    {
        Info<<"destroy ModifiedForRoughness sha1: 23a0898b871225a107d840bf2d00f9cd44412810\n";
    }
}
...
void ModifiedForRoughnessFixedValueFvPatchScalarField::updateCoeffs()
{
    ...
    if (false)
    {
        Info<<"updateCoeffs ModifiedForRoughness sha1: 23a0898b871225a107d840bf2d00f9cd44412810\n";
    }

//{{{ begin code
    #line 56 "/d1/home/bini/General/paperWithJoel/AdanedOF/dakota/Ap35dp2T7/workdir.10/0/omega.boundaryField.bottomWall"
const fvPatch& boundaryPatch = patch();                // give access to boundary mesh patch mesh
      ...
      //    const vectorField& normal = patch().nf();              // give access to the face normal 
            ...
            scalar Zr = 2.50;                                      // roughness to be incorporated 
