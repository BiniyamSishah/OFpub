...
//{{{ begin codeInclude
#line 36 "/d1/home/bini/General/paperWithJoel/AdanedOF/dakota/Ap15dp2T7/workdir.1/0/omega.boundaryField.bottomWall"
#include "fvCFD.H"
                #include "cmath"
                #include "iostream"
//}}} end codeInclude
...
{
    // dynamicCode:
    // SHA1 = 49f14ab95802b3fb0c518dabcb5e105775d2fa9d
    //
    // unique function name that can be checked if the correct library version
    // has been loaded
    void ModifiedForRoughness_49f14ab95802b3fb0c518dabcb5e105775d2fa9d(bool load)
    {
        if (load)
        {
...
const char* const ModifiedForRoughnessFixedValueFvPatchScalarField::SHA1sum =
    "49f14ab95802b3fb0c518dabcb5e105775d2fa9d";
    ...
    fixedValueFvPatchField<scalar>(p, iF)
{
    if (false)
    {
        Info<<"construct ModifiedForRoughness sha1: 49f14ab95802b3fb0c518dabcb5e105775d2fa9d"
...
~ModifiedForRoughnessFixedValueFvPatchScalarField()
{
    if (false)
    {
        Info<<"destroy ModifiedForRoughness sha1: 49f14ab95802b3fb0c518dabcb5e105775d2fa9d\n";
    }
}
...
void ModifiedForRoughnessFixedValueFvPatchScalarField::updateCoeffs()
{
    ...
    if (false)
    {
        Info<<"updateCoeffs ModifiedForRoughness sha1: 49f14ab95802b3fb0c518dabcb5e105775d2fa9d\n";
    }

//{{{ begin code
    #line 56 "/d1/home/bini/General/paperWithJoel/AdanedOF/dakota/Ap15dp2T7/workdir.1/0/omega.boundaryField.bottomWall"
const fvPatch& boundaryPatch = patch();                // give access to boundary mesh patch mesh
      ...
      //    const vectorField& normal = patch().nf();              // give access to the face normal 
            ...
            scalar Zr = 0.450;                                      // roughness to be incorporated 
